...
T = TypeVar("T", bound="ListWebhooksResponseLinks")
...
class ListWebhooksResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_webhooks_response_links = cls(
            prev=prev,
            next_=next_,
        )

        list_webhooks_response_links.additional_properties = d
        return list_webhooks_response_links
