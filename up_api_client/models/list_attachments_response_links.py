...
T = TypeVar("T", bound="ListAttachmentsResponseLinks")


@_attrs_define
class ListAttachmentsResponseLinks:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_attachments_response_links = cls(
            prev=prev,
            next_=next_,
        )

        list_attachments_response_links.additional_properties = d
        return list_attachments_response_links
