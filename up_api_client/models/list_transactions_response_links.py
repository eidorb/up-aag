...
T = TypeVar("T", bound="ListTransactionsResponseLinks")
...
class ListTransactionsResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_transactions_response_links = cls(
            prev=prev,
            next_=next_,
        )

        list_transactions_response_links.additional_properties = d
        return list_transactions_response_links
