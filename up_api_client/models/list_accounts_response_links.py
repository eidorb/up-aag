...
T = TypeVar("T", bound="ListAccountsResponseLinks")
...
class ListAccountsResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        list_accounts_response_links = cls(
            prev=prev,
            next_=next_,
        )

        list_accounts_response_links.additional_properties = d
        return list_accounts_response_links
